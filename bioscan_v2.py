...
#checkboxes to create more accurate results

counter = 0

st.subheader('Complete the Survey below based on the symptoms you are experiencing: \n')
itchy = st.checkbox('Itchy')
painful = st.checkbox('Painful')
bleeds = st.checkbox('Occasionally bleeds')
burns = st.checkbox('Burning sensation')
quick = st.checkbox('Quickly developed')
